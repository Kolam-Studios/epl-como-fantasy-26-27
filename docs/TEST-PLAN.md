...
| 7 | Phase 1→2 transition; no-bids nominatable; rotation skips full; ends 15/15 | ✅ (engine) | `test:lot` (62 checks): end-phase-one refuses while lot unresolved or players unoffered; nomination rotation order enforced; full squads skipped. **Run 4 adds a scripted full-auction drill**: simulate a complete night (120 sales + no-bids + phase 2) ending all squads 15/15 |
